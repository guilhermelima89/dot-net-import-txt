...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api.Models.ArquivoComErroValidacao", b =>
                {
                    ...
                    b.Property<int>("NumeroLinhaArquivoOriginal")
                        .HasColumnType("int");

                    b.Property<string>("TextoLinhaArquivoOriginal")
                        .IsRequired()
                        .HasColumnType("varchar(250)");
            ...
            modelBuilder.Entity("Api.Models.ArquivoErro", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ArquivoErro", (string)null);
                });
            ...
            modelBuilder.Entity("Api.Models.ArquivoStatus", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DataCadastro = new DateTime(2022, 9, 18, 14, 45, 23, 69, DateTimeKind.Local).AddTicks(4642),
                            Descricao = "Aguardando processamento"
                        },
                        new
                        {
                            Id = 2,
                            DataCadastro = new DateTime(2022, 9, 18, 14, 45, 23, 69, DateTimeKind.Local).AddTicks(4662),
                            Descricao = "Processado sem erros"
                        },
                        new
                        {
                            Id = 3,
                            DataCadastro = new DateTime(2022, 9, 18, 14, 45, 23, 69, DateTimeKind.Local).AddTicks(4664),
                            Descricao = "Processado parcialmente com erros"
                        },
                        new
                        {
                            Id = 4,
                            DataCadastro = new DateTime(2022, 9, 18, 14, 45, 23, 69, DateTimeKind.Local).AddTicks(4665),
                            Descricao = "Não processado"
                        },
                        new
                        {
                            Id = 5,
                            DataCadastro = new DateTime(2022, 9, 18, 14, 45, 23, 69, DateTimeKind.Local).AddTicks(4666),
